...
def main():
    ...
    if ratings_csv.exists():
        ...
        count_expected = con.execute(f"SELECT COUNT(*) FROM read_csv_auto('{ratings_csv}')").fetchone()[0]
    ...
    traited_file = ["ratings.csv", "movies.csv", "links.csv", "tags.csv", "genome-tags.csv", "genome-scores.csv"]
